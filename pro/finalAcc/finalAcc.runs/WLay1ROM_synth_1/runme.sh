...
HD_PWD='D:/GradeFour/AICHIP/ref/project/repo/FinalPro-CnnAcc/pro/finalAcc/finalAcc.runs/WLay1ROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WLay1ROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WLay1ROM.tcl
