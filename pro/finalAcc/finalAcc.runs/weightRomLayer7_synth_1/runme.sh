...
HD_PWD='D:/OneDrive/course/Grade2_Autumn/FPGA/final-project/new/pro/finalAcc/finalAcc.runs/weightRomLayer7_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log weightRomLayer7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source weightRomLayer7.tcl
