...
HD_PWD='D:/GradeFour/AICHIP/ref/project/repo/FinalPro-CnnAcc/pro/finalAcc/finalAcc.runs/BRAM8K1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BRAM8K1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BRAM8K1.tcl
