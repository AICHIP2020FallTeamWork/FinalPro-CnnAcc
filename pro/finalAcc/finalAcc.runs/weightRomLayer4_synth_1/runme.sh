...
HD_PWD='D:/GradeFour/AICHIP/ref/project/repo/FinalPro-CnnAcc/pro/finalAcc/finalAcc.runs/weightRomLayer4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log weightRomLayer4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source weightRomLayer4.tcl
