...
HD_PWD='D:/GradeFour/AICHIP/ref/project/repo/FinalPro-CnnAcc/pro/finalAcc/finalAcc.runs/BRAM32k_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BRAM32k.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BRAM32k.tcl
