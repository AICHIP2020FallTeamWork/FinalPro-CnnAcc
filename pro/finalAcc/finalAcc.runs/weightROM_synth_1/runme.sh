...
HD_PWD='D:/GradeFour/AICHIP/ref/project/repo/FinalPro-CnnAcc/pro/finalAcc/finalAcc.runs/weightROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log weightROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source weightROM.tcl
