...
#
# Generated by export_simulation on Fri Jan 08 02:03:38 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './weightRomLayer3.sh' script.

./weightRomLayer3.sh -reset_run
...
./weightRomLayer3.sh -noclean_files

For more information on the script, please type './weightRomLayer3.sh -help'.
