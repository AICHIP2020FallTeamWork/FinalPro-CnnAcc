...
#
# Generated by export_simulation on Sun Dec 13 16:47:14 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './BRAM4k.sh' script.
...
./BRAM4k.sh -noclean_files

For more information on the script, please type './BRAM4k.sh -help'.
