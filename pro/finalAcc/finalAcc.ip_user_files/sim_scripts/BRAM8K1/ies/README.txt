...
#
# Generated by export_simulation on Mon Dec 21 12:25:15 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './BRAM8K1.sh' script.

./BRAM8K1.sh -reset_run
...
./BRAM8K1.sh -noclean_files

For more information on the script, please type './BRAM8K1.sh -help'.
