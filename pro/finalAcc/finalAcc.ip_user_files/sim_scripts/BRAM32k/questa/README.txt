...
#
# Generated by export_simulation on Fri Jan 08 02:03:50 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './BRAM32k.sh' script.

./BRAM32k.sh -reset_run
...
./BRAM32k.sh -noclean_files

For more information on the script, please type './BRAM32k.sh -help'.
