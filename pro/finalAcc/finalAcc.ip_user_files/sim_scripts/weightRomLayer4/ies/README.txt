...
#
# Generated by export_simulation on Tue Dec 22 02:10:28 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './weightRomLayer4.sh' script.

./weightRomLayer4.sh -reset_run
...
./weightRomLayer4.sh -noclean_files

For more information on the script, please type './weightRomLayer4.sh -help'.
