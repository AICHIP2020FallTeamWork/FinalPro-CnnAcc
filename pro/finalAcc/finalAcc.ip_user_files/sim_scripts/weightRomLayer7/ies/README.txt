...
#
# Generated by export_simulation on Wed Dec 23 03:28:54 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './weightRomLayer7.sh' script.

./weightRomLayer7.sh -reset_run
...
./weightRomLayer7.sh -noclean_files

For more information on the script, please type './weightRomLayer7.sh -help'.
