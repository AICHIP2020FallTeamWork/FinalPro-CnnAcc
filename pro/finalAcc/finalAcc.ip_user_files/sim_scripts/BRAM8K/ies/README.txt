...
#
# Generated by export_simulation on Wed Dec 23 02:12:55 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './BRAM8K.sh' script.
...
./BRAM8K.sh -noclean_files

For more information on the script, please type './BRAM8K.sh -help'.
